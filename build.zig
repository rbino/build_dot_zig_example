...
pub fn build(b: *std.Build) void {
    ...
    const lib_name = if (target.isWindows()) "math.dll" else "math.so";
    const nif_so_install = b.addInstallFileWithDir(lib.getOutputSource(), .lib, lib_name);
